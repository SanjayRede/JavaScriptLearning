...
console.log((`1) find "TCS" Employee Ditails :`));
...
array.forEach((currentValue)=>{
    ...
    console.log(`2) Find the employees with having salary greator than 50000 ..`);
array.forEach((currentValue)=>{
...
console.log(`3) Find the sum of All employees Salary and log it..`);

let sum =0;
array.forEach((currentValue)=>{
   sum += currentValue.emp_salary;
});
console.log(` All Employees Sum of Salary is:-${sum}`);
console.log(`--------------------------------------------------------------------------------------------------`);

console.log(`4) Find the average salary of all the employees and log it )`);
...
console.log(`5) Find the IT or HR department employees salary greator than or equal to 75000 & log details)`);
